...
router.get("/", async (req, res) => {
    const username = req.query.user; //"query" refers to what comes after the question mark in the url. The fact that i put it as "req.query.user" means that after the question mark in the url, eg. user=Jane, will display all posts made by the person with the username Jane. Note that this filtering is possible because the Post model has a "username" and "categories" properties in the schema. 
