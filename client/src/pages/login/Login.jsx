...
export default function Login() {
  ...
  //since i used useref for the username and password, and passed them into the inpt tag, i dont have to do "onChange=..." in the tags. The value is passed automatically since useref stores the value of mutable objects.
